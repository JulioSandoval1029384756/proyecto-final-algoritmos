...
class Productos:
    def __init__(self, root):
        self.wind = root
        self.wind.title("Sistema Transaccional de Ventas")
        self.wind.geometry("1071x630")
        self.wind.config(bg="medium sea green")

        self.notebook = ttk.Notebook(self.wind)
        self.notebook.pack(fill="both", expand="yes", padx=10, pady=20)
        ...
        self.notebook.add(self.frame_inventario, text="CONTROL DE INVENTARIO")
        self.notebook.add(self.frame_clientes, text="CONTROL DE CLIENTES")
        self.notebook.add(self.frame_ventas, text="CONTROL DE VENTAS")
    ...
    def run_query(self, query, parameters=()):
        ...
        database = "ingrese nombre de base de datos"
    ...
    def inventario_frame(self):
        ...
        frame = LabelFrame(self.frame_inventario, text="CONTROL DE INVENTARIO", font=("Times New Roman", 18), bg="lightblue")
        frame.pack(fill="both", expand="yes", padx=20, pady=20,)
        frame.config(bg="spring green")

        # Área para productos
        self.trv_productos = ttk.Treeview(frame, columns=("Código", "Nombre", "Existencia", "Proveedor", "Precio"), show="headings", height=6)
        self.trv_productos.grid(row=0, column=0, columnspan=10)
        ...
        btn_agregar_producto = Button(frame, text="Crear Producto", font=("Times New Roman", 16),command=self.agregar_producto, bg="sea green", fg="white", width=16, height=2)
        btn_agregar_producto.grid(row=1, column=0, padx=20, pady=40)

        btn_actualizar_producto = Button(frame, text="Actualizar Producto", font=("Times New Roman", 16), command=self.actualizar_producto, bg="sea green", fg="white", width=16, height=2)
        btn_actualizar_producto.grid(row=1, column=1, padx=20, pady=40)

        btn_eliminar_producto = Button(frame, text="Eliminar Producto", font=("Times New Roman", 16), command=self.eliminar_producto, bg="dark slate blue", fg="white", width=16, height=2)
        btn_eliminar_producto.grid(row=1, column=2, padx=20, pady=40)

        # Agregar productos
        al1 = Label(frame, text="Código:", width=16, bg="spring green", font=("Times New Roman", 15))
        al1.grid(row=2, column=0, padx=5, pady=5)
        self.ent1 = Entry(frame)
        self.ent1.grid(row=2, column=1, padx=5, pady=5)

        al2 = Label(frame, text="Nombre:", width=16, bg="spring green", font=("Times New Roman", 15))
        al2.grid(row=3, column=0, padx=5, pady=5)
        self.ent2 = Entry(frame)
        self.ent2.grid(row=3, column=1, padx=5, pady=5)

        al3 = Label(frame, text="Existencia:", width=16, bg="spring green", font=("Times New Roman", 15))
        al3.grid(row=4, column=0, padx=5, pady=5)
        self.ent3 = Entry(frame)
        self.ent3.grid(row=4, column=1, padx=5, pady=5)

        al4 = Label(frame, text="Proveedor:", width=16, bg="spring green", font=("Times New Roman", 15))
        al4.grid(row=5, column=0, padx=5, pady=5)
        self.ent4 = Entry(frame)
        self.ent4.grid(row=5, column=1, padx=5, pady=5)

        al5 = Label(frame, text="Precio:", width=16, bg="spring green", font=("Times New Roman", 15))
        al5.grid(row=6, column=0, padx=5, pady=5)
        self.ent5 = Entry(frame)
        self.ent5.grid(row=6, column=1, padx=5, pady=5)
    ...
    def actualizar_producto(self):
        ...
        Label(frame, text="Editar Nuevo Precio:", width=18, bg="spring green", font=("Times New Roman", 12)).grid(row=0, column=0, padx=5, pady=3)
        nuevo_precio = Entry(frame)
        nuevo_precio.grid(row=0, column=1, padx=5, pady=3)

        Label(frame, text="Editar Nueva Existencia:", width=18, bg="spring green", font=("Times New Roman", 12)).grid(row=1, column=0, padx=5, pady=3)
        nueva_existencia = Entry(frame)
        nueva_existencia.grid(row=1, column=1, padx=5, pady=3)

        Button(frame, text="Actualizar", font=("Times New Roman", 13), bg="dark slate blue", fg="white", command=lambda: self.edit_record(codigo, nuevo_precio.get(), nueva_existencia.get()), width=15).grid(row=2, column=1, padx=10, pady=5)
    ...
    def clientes_frame(self):
        ...
        frame = LabelFrame(self.frame_clientes, text="CONTROL DE CLIENTES", font=("Times New Roman", 18), bg="lightblue")
        frame.pack(fill="both", expand="yes", padx=20, pady=20)
        frame.config(bg="spring green")

        # Área para clientes
        self.trv_clientes = ttk.Treeview(frame, columns=("Código", "Nombre", "Dirección"), show="headings", height=6)
        self.trv_clientes.grid(row=0, column=0, columnspan=10)
        ...
        btn_agregar_cliente = Button(frame, text="Agregar Cliente", font=("Times New Roman", 16), command=self.agregar_cliente, bg="sea green", fg="white", width=16, height=2)
        btn_agregar_cliente.grid(row=1, column=0, padx=20, pady=40)

        btn_actualizar_cliente = Button(frame, text="Actualizar Cliente", font=("Times New Roman", 16), command=self.actualizar_cliente, bg="sea green", fg="white", width=16, height=2)
        btn_actualizar_cliente.grid(row=1, column=1, padx=20, pady=40)

        btn_eliminar_cliente = Button(frame, text="Eliminar Cliente", font=("Times New Roman", 16), command=self.eliminar_cliente, bg="dark slate blue", fg="white", width=16, height=2)
        btn_eliminar_cliente.grid(row=1, column=2, padx=20, pady=40)

        # Campos para agregar clientes
        al6 = Label(frame, text="Código Cliente:", width=16, bg="spring green", font=("Times New Roman", 16))
        al6.grid(row=2, column=0, padx=5, pady=5)
        self.ent6 = Entry(frame)
        self.ent6.grid(row=2, column=1, padx=5, pady=5)

        al7 = Label(frame, text="Nombre Cliente:", width=16, bg="spring green", font=("Times New Roman", 16))
        al7.grid(row=3, column=0, padx=5, pady=5)
        self.ent7 = Entry(frame)
        self.ent7.grid(row=3, column=1, padx=5, pady=5)

        al8 = Label(frame, text="Dirección Cliente:", width=16, bg="spring green", font=("Times New Roman", 16))
        al8.grid(row=4, column=0, padx=5, pady=5)
        self.ent8 = Entry(frame)
        self.ent8.grid(row=4, column=1, padx=5, pady=5)
    ...
    def actualizar_cliente(self):
        ...
        Label(frame, text="Cambiar Nombre del Cliente:", width=20, bg="spring green", font=("Times New Roman", 12)).grid(row=0, column=0, padx=5, pady=3)
        nuevo_nombre_cliente = Entry(frame)
        nuevo_nombre_cliente.grid(row=0, column=1, padx=5, pady=3)

        Label(frame, text="Cambiar Dirección del Cliente:", width=20, bg="spring green", font=("Times New Roman", 12)).grid(row=1, column=0, padx=5, pady=3)
        nueva_direccion_cliente = Entry(frame)
        nueva_direccion_cliente.grid(row=1, column=1, padx=5, pady=3)

        Button(frame, text="Actualizar", font=("Times New Roman", 13), bg="dark slate blue", fg="white", command=lambda: self.edit_cliente(codigo_cliente, nuevo_nombre_cliente.get(), nueva_direccion_cliente.get()), width=15).grid(row=2, column=1, padx=10, pady=5)
    ...
    def ventas_frame(self):
        ...
        frame = LabelFrame(self.frame_ventas, text="CONTROL DE VENTAS", font=("Times New Roman", 18), bg="lightblue")
        frame.pack(fill="both", expand="yes", padx=20, pady=20)
        frame.config(bg="spring green")

        # Área para ventas
        self.trv_ventas = ttk.Treeview(frame, columns=("Código Venta", "Código Producto", "Código Cliente", "Cantidad", "Total"), show="headings", height=6)
        ...
        btn_crear_venta = Button(frame, text="Crear Venta", font=("Times New Roman", 16), command=self.crear_venta, bg="sea green", fg="white", width=16, height=2)
        btn_crear_venta.grid(row=1, column=0, padx=20, pady=40)

        btn_anular_venta = Button(frame, text="Anular Venta", font=("Times New Roman", 16), command=self.anular_venta, bg="dark slate blue", fg="white", width=16, height=2)
        btn_anular_venta.grid(row=1, column=1, padx=20, pady=40)

        # Agregar ventas
        al9 = Label(frame, text="Código Venta:", width=16, bg="spring green", font=("Times New Roman", 16))
        al9.grid(row=2, column=0, padx=5, pady=5)
        self.ent9 = Entry(frame)
        self.ent9.grid(row=2, column=1, padx=5, pady=5)

        al10 = Label(frame, text="Código Producto:", width=16, bg="spring green", font=("Times New Roman", 16))
        al10.grid(row=3, column=0, padx=5, pady=5)
        self.ent10 = Entry(frame)
        self.ent10.grid(row=3, column=1, padx=5, pady=5)

        al11 = Label(frame, text="Código Cliente:", width=16, bg="spring green", font=("Times New Roman", 16))
        al11.grid(row=4, column=0, padx=5, pady=3)
        self.ent11 = Entry(frame)
        self.ent11.grid(row=4, column=1, padx=5, pady=5)

        al12 = Label(frame, text="Cantidad:", width=16, bg="spring green", font=("Times New Roman", 16))
        al12.grid(row=5, column=0, padx=5, pady=5)
        self.ent12 = Entry(frame)
        self.ent12.grid(row=5, column=1, padx=5, pady=5)
